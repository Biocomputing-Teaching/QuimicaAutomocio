...
\marginnote{\linkurl{https://commons.wikimedia.org/wiki/File:Geiger-Marsden_experiment_expectation_and_result.svg}}
.
...
\begin{marginfigure}
\centering
\includegraphics[scale=0.45]{ParticulaCaixa.png}
...
\begin{marginfigure}
\centering
\includegraphics[scale=0.25]{D2s2p.png}
