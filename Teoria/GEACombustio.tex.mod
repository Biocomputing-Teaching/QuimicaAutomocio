...
La termodinàmica de la combustió estudia els canvis d'energia i matèria en les reaccions de combustió. Aquestes reaccions són exotèrmiques, ja que alliberen energia en forma de calor. La quantitat d'energia alliberada es pot mesurar amb un calorímetre, un aparell que mesura la calor generada per una reacció química. La calor generada per la combustió d'una quantitat de combustible s'anomena calor de combustió, i es mesura en \si{\joule\per\mole}. Aquesta quantitat varia segons el combustible i la seva composició.

Farem primer una breu introducció a les lleis de la termodinàmica, que ens permetran entendre millor els processos de combustió.
