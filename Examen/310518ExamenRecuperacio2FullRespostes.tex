...
\usepackage[answersheet]{urmathtest_cat}[2001/05/12]
...
\item[x] Troba la constant d'equilibri de la pila de Daniell (que explota el potencial elèctric de la reacció \ch{Cu^{2+}_{(aq)} + Zn_{(s)} -> Cu_{(s)} + Zn^{2+}_{(aq)}}), sabent que 
